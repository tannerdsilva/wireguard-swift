extension KCPControlBlock {
	...
	internal struct RoundTripTimeInfo:Sendable {
		...
		internal var rx_srtt:UInt64 = 0
		/// the smoothed round trip time variance
		internal var rx_rttval:UInt64 = 0
		/// the current retransmission timeout
		internal var rx_rto:UInt64
		/// the minimum retransmission timeout
		internal let rx_minrto:UInt64
		/// the maximum retransmission timeout
		internal let rx_maxrto:UInt64
		...
		internal init(rx_rto:UInt64 = IKCP_RTO_DEF, rx_minrto:UInt64 = IKCP_RTO_MIN, rx_maxrto:UInt64 = IKCP_RTO_MAX) {
			self.rx_rto = rx_rto
